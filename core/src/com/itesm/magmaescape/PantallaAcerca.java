...
public class PantallaAcerca extends Pantalla
{
    ...
    private com.itesm.magmaescape.AsheAcerca asheAmauri, asheDaniel, asheNorma, asheDenisse;
    ...
    private void crearAshesAcerca() {
        ...
        asheAmauri = new com.itesm.magmaescape.AsheAcerca(texturaAmauri,ANCHO*0.085f,ALTO/3f,196,249);
        Texture texturaDaniel = new Texture("acercaDe/AsheDaniel.png");
        asheDaniel = new com.itesm.magmaescape.AsheAcerca(texturaDaniel,ANCHO*0.32f,ALTO/3f,194,246);
        Texture texturaNorma = new Texture("acercaDe/AshesNorma.png");
        asheNorma = new com.itesm.magmaescape.AsheAcerca(texturaNorma,ANCHO*0.53f,ALTO/3f,196,249);
    ...
    private void crearAcercaDe() {
        ...
        btnRegresar.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                //Cambiar pantalla
                juego.setScreen(new com.itesm.magmaescape.PantallaMenu(juego));
            }
        });
