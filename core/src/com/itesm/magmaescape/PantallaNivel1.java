...
public class PantallaNivel1 extends Pantalla {
    ...
    private com.itesm.magmaescape.Olivia olivia;
    ...
    //Animacion (Peces)
    private Array<com.itesm.magmaescape.Pez> arrPeces;
    ...
    public void render(float delta) {
       ...
       olivia.render(batch);
        ...
        //Dibujar Peces
        for (com.itesm.magmaescape.Pez pez : arrPeces) {
            pez.render(batch);
        }
        ...
        if(estadoOlivia != com.itesm.magmaescape.EstadoOlivia.MURIENDO && (int)tiempo==30){
    ...
    private void actualizar(float delta) {
        if(estadoJuego== EstadoJuego.JUGANDO  && estadoOlivia != com.itesm.magmaescape.EstadoOlivia.MURIENDO && (estadoOlivia != com.itesm.magmaescape.EstadoOlivia.MURIENDO && (int)tiempo<30) ){
            actualizarFondo();
    ...
    private void actualizarAshes(float delta) {
        ...
        if (timerCreaAshe>=TIEMPO_CREAR_ASHE) {
            ...
            com.itesm.magmaescape.Ashe ashe = new com.itesm.magmaescape.Ashe(texturaAshe, xAshe, ALTO/4f, -300);
            arrAshes.add(ashe);
        }
    ...
    public class ProcesadorEntrada implements InputProcessor{
        ...
        public boolean touchDown(int screenX, int screenY, int pointer, int button) {
            ...
            if (estadoOlivia == com.itesm.magmaescape.EstadoOlivia.PAUSA ){
                ...
                if (v.x >= ANCHO/2){
                    estadoOlivia = com.itesm.magmaescape.EstadoOlivia.CAMINADO;
                }
                else
            ...
            if (estadoOlivia == com.itesm.magmaescape.EstadoOlivia.MURIENDO){
               // juego.reproducir(Juego.TipoMusica.MUERTE);
                if (v.x >= ANCHO/2){
                    juego.setScreen(new com.itesm.magmaescape.PantallaCargando(juego, com.itesm.magmaescape.Pantallas.NIVEL1));
                }
                else
                {
                    Preferences prefs = Gdx.app.getPreferences("MusicPreference");
