...
public class Olivia extends Objeto {
    ...
    private com.itesm.magmaescape.EstadoOlivia estado;
    ...
    public Olivia(Texture textura, float x, float y, float inicialY, float gravity){
       ...
       g = gravity;
        ...
        estado = com.itesm.magmaescape.EstadoOlivia.CAMINADO;
    ...
    public void saltar() {
        if ( estado != com.itesm.magmaescape.EstadoOlivia.SALTANDO){
            reproducirSalto();
            tAire = 0;
            tVuelo =  2*v0y/ g;
            estado = com.itesm.magmaescape.EstadoOlivia.SALTANDO;
        }

    }


    public com.itesm.magmaescape.EstadoOlivia getEstado(){
        return estado;
    }
